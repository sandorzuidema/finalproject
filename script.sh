...
function randstad_right {
	...
	zless /net/corpora/twitter2/Tweets/2021/02 *.gz  | /net/corpora/twitter2/tools/tweet2tab -i text user.location \
	grep -w -e 'Amsterdam, Nederland' -e 'Rotterdam, Nederland' -e 'Den Haag, Nederland' \
	grep -iw -e  'CDA' -e 'SGP' -e 'VVD' -e 'JA21' -e 'FvD' | wc -l	
	echo
}
...
function non_randstad_left {
	...
	zless /net/corpora/twitter2/Tweets/2021/02 *.gz  | /net/corpora/twitter2/tools/tweet2tab -i text user.location \
	grep ', Nederland'| grep -v -e 'Amsterdam, Nederland' -e 'Rotterdam, Nederland' -e 'Den Haag, Nederland' \
	grep -iw -e  'PvdD' -e 'GL' -e 'PvdA' -e 'SP' -e 'CU' -e 'D66' -e '50-plus' -e 'PVV' | wc -l
	echo
}
